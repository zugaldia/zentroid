...
a._update_centroid()})};a.switch_google=function(){a.set_message("Switched to Google Maps.")};a.switch_mapbox=function(){a.set_message("Switched to MapBox.")};a._update_centroid=function(){1<d.length&&(e&&b.removeLayer(e),e=new L.Marker(a._get_centroid_coordinates(),{icon:new h}),b.addLayer(e),a.set_message("X marks the spot."))};a._get_centroid_coordinates=function(){for(var a=0,c=0,b=0;b<d.length;b++)a+=d[b].lat,c+=d[b].lng;return new L.LatLng(a/d.length,c/d.length)};return a}
